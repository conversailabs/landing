...
const AboutUsPage = () => {
  return (
    <section id="about" className="py-16 bg-accent text-center">
      <div className="container mx-auto px-4">
        <h1 className="text-4xl font-bold mb-6 text-foreground">About Us</h1>

        <div className="max-w-3xl mx-auto space-y-6">
          <p className="text-lg text-muted-foreground leading-relaxed">
            Welcome to ConversAILabs! We're a team of AI and voice technology experts dedicated to
            transforming how businesses handle customer communications. Our AI-powered voice agents
            automate conversations while maintaining the human touch your customers expect.
          </p>
